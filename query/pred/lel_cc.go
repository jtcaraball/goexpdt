...
// LELConstConst is the constant-constant version of the Less or Equal Level
// predicate.
type LELConstConst struct {
	I1 query.QConst
	I2 query.QConst
}
...
// l.I2.
func (l LELConstConst) Encoding(ctx query.QContext) (cnf.CNF, error) {
	if ctx == nil {
