...
// Return and operator.
func And(child1, child2 base.Component) *and {
	return &and{child1: child1, child2: child2}
}

// Return CNF encoding of component.
func (a *and) Encoding(ctx *base.Context) (*cnf.CNF, error) {
...
func (a *and) GetChildren() []base.Component {
	return []base.Component{a.child1, a.child2}
}
